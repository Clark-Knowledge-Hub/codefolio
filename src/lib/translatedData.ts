...
export const getProjectsData = (language: "pt" | "en") => {
  ...
  return [
    {
      title: t.projects.pomocube.title,
      subtitle: t.projects.pomocube.subtitle,
      description: t.projects.pomocube.description,
      technologies: [
        "Java",
        "Spring Boot",
        "MongoDB",
      ...
      github: {
        backend: "https://github.com/ClarkAshida/pomodoro-api",
        frontend: "https://github.com/ClarkAshida/pomodoro-web",
      },
      demo: "https://pomodoro-web-amber.vercel.app/",
      highlights: t.projects.pomocube.highlights,
    },
    {
  ...
  return [
    {
      ...
      technologies: [
        ...
        "JUnit, Mockito, JaCoCo, Jest, Cypress",
        "Docker, Git, GitLab CI/CD, Scrum",
      ],
    },
    {
    ...
    },
    {
      ...
      technologies: ["Python, PowerShell", "Hardware, Infraestrutura de Rede"],
    },
  ];
};
