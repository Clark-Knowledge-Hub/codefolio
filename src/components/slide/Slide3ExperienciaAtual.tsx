...
const Slide3ExperienciaAtual = () => {
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-background-secondary py-8 overflow-hidden">
      <div className="container mx-auto px-6 h-full flex flex-col justify-center">
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="text-center mb-8">
            ...
            {/* Company Badge */}
            <div className="inline-flex flex-col items-center gap-2 bg-card border-2 border-primary/30 px-6 py-4 rounded-2xl shadow-card">
          ...
          <div className="grid lg:grid-cols-5 gap-6">
            ...
            <motion.div variants={fadeInUp} className="lg:col-span-2">
              <div className="relative h-full min-h-[300px] bg-gradient-to-br from-primary/10 via-background to-primary/5 rounded-2xl border-2 border-card-border shadow-card flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-8xl opacity-10">🏫</div>
                </div>
                <div className="relative text-center p-6">
                  <div className="text-4xl font-bold text-primary/50 mb-2">
                    LANCE
                  </div>
