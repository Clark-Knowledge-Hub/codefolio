...
const Slide7EncerramentoDevops = () => {
  const { language } = useLanguage();
  const t = presentationDevopsTranslations[language].slide7;
      ...
      <div className="container mx-auto px-20 relative z-10">
        ...
        >
          ...
          <motion.div variants={fadeInUp}>
            <a
              href={`mailto:${t.contact.email}?subject=${language === "pt" ? "Conversa sobre DevOps" : "DevOps Conversation"}`}
...
export default Slide7EncerramentoDevops;
