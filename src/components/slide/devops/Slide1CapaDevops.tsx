...
const Slide1CapaDevops = () => {
  ...
  const techIcons = [
    ...
    { Icon: SiPrometheus, name: "Prometheus", color: "text-[#e6522c]" },
    { Icon: SiGrafana, name: "Grafana", color: "text-[#f46800]" },
  ];
    ...
    <div className="h-screen flex items-center justify-center bg-gradient-hero relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          {/* Tech Stack Icons - DevOps Focused */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
...
export default Slide1CapaDevops;
